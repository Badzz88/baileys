...
// XEdDSA signing). Matches the 8.5.3 approach: AES/HKDF/SHA/HMAC/Curve no
// longer depend on the `whatsapp-rust-bridge` native module at all, so a
// broken or unloadable bridge can no longer break session/key creation here.
...
// getEnabledFeatures used to report which native-bridge features were active;
// kept as a stub for API compatibility since nothing else in this bridge
// relies on the native module anymore.
const getEnabledFeatures = () => ({})
Object.defineProperty(exports, 'getEnabledFeatures', { enumerable: true, get: () => getEnabledFeatures })
